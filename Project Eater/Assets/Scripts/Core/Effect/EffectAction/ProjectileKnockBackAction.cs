...
[System.Serializable]
public class ProjectileKnockBackAction : EffectAction
{
    [SerializeField]
    ...
    public override bool Apply(Effect effect, Entity user, Entity target, int level, int stack, float scale)
    {
        ...
        target.rigidbody.AddForce(knockBackDirection * knockBackPower * 20f, ForceMode2D.Force);
    ...
    {
        return new ProjectileKnockBackAction()
        {
